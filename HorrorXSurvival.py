...
def check_room():
    print(" nothing is found in this room ")
    room1()
...
def search_surrounding():
    ...
    print("1 found_box")
    player = int(input(" Press 1 to open the box:"))
    if(player == 1):
...
def kitchen():
    ...
    player = int(input(" Tap 1 for searching: "))
    if((player == 1)):
...
def shotgun():
            ...
            player = int(input("Tap 1 to load the shotgun"))
            if(player ==1):
...
def found_a_letter():
    print("Hey, if you're reading this, I'm already dead.\n\nI've been trapped in this place for a year.\n\nI came here with my friends, but they all disappeared. I know the monster killed them.\n\nI tried to escape many times, but it always found me.\n\nIf you want to survive... stay out of its sight.")
    monster()
...
def room_4():
    ...
    player = int(input("Tap 1 to use the coat:"))
...
def basement():
    ...
    player = int(input("Tap 1 to have basement key:"))
    if(player == 1):
...
def car_key():
    ...
    player = int(input("Tap 1 to have car key:"))
    if(player == 1):
...
def room4():
    ...
    print(" 1 secret room")
    player = int(input("Tap 1 to enter in secret room:"))
    if(player ==1):
